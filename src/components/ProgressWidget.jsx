      ...
      <div className="relative h-56 w-56">
        <svg viewBox="0 0 200 200" className="h-full w-full">
          ...
          <g clipPath="url(#sphereClip)">
            ...
            <g
              style={{
                transform: `translateY(${-safeProgress * 2}px)`,
                transformOrigin: 'center',
              }}
            >
              <rect x="0" y="200" width="200" height="200" fill={liquidColor} fillOpacity="0.25" />
              <path
                className="wave wave-back"
                fill={liquidColor}
                fillOpacity="0.35"
                d="M0 200 Q 25 190 50 200 T 100 200 T 150 200 T 200 200 V400 H0 Z"
              />
              <path
                className="wave wave-front"
                fill={liquidColor}
                fillOpacity="0.7"
                d="M0 200 Q 25 210 50 200 T 100 200 T 150 200 T 200 200 V400 H0 Z"
              />
            </g>
          </g>
